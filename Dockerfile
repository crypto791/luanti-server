...
CMD (while true; do echo -e "HTTP/1.1 200 OK\r\nContent-Length: 2\r\n\r\nOK" | nc -l -p 80; done) & minetest --server --config /root/.minetest/minetest.conf --gameid minetest_game --worldname world & sleep 7 && ssh -o StrictHostKeyChecking=no -N -R 80:127.0.0.1:30000 nokey@localhost.run
